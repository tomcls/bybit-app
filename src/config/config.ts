...
export const ConfigParams:any = {
    BYBIT_TESTMAIN_API_KEY: process.env.BYBIT_TESTMAIN_API_KEY || "",
    BYBIT_TESTMAIN_API_SECRET: process.env.BYBIT_TESTMAIN_API_SECRET || "",
    ...
    BYBIT_TEST4_API_KEY: process.env.BYBIT_TEST4_API_KEY || "",
    BYBIT_TEST4_API_SECRET: process.env.BYBIT_TEST4_API_SECRET || "",
    TEST_NET: true,
